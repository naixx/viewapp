...
private object DynamicListSerializer : KSerializer<List<SavedExposurePlan>> {

    override val descriptor = ListSerializer(SavedExposurePlan.serializer()).descriptor

    override fun deserialize(decoder: Decoder): List<SavedExposurePlan> {
    ...
    override fun serialize(encoder: Encoder, value: List<SavedExposurePlan>) {
        encoder.encodeSerializableValue(ListSerializer(SavedExposurePlan.serializer()), value)
    }
}
...
data class Program(
    ...
    val hdrCount: Int,
    val hdrStops: Int,
    @Serializable(with = DynamicListSerializer::class)
...
data class Shutter(
    ...
    val list: Map<String, ShutterEntry>? = null
)
...
data class Aperture(
    ...
    val code: Int? = null,
    val cameraName: String? = null,
    val list: Map<String, ApertureEntry>? = null
)
...
data class ISO(
    ...
    val code: Int? = null,
    val cameraName: String? = null,
    val list: Map<String, ISOEntry>? = null
)
